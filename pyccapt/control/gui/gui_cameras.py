...
class Ui_Cameras_Alignment(object):
	...
	def setupUi(self, Cameras_Alignment):
		...
		# Side camera (x, y) main arrow
		arrow1 = pg.ArrowItem(pos=(690, 593), angle=-90)
		...
		arrow1 = pg.ArrowItem(pos=(465, 105), angle=90, brush='r')
		self.cam_s_d.addItem(arrow1)
		# bottom camera zoom (x, y) zoom arrow
		arrow1 = pg.ArrowItem(pos=(460, 115), angle=90, brush='r')
