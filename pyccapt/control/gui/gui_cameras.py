...
class Ui_Cameras_Alignment(object):
	...
	def setupUi(self, Cameras_Alignment):
		...
		# Side camera (x, y)
		arrow1 = pg.ArrowItem(pos=(610, 545), angle=-90)
		arrow2 = pg.ArrowItem(pos=(635, 1580), angle=90)
		...
		arrow1 = pg.ArrowItem(pos=(260, 57), angle=90, brush='r')
		self.cam_s_d.addItem(arrow1)
		# bottom camera zoom (x, y)
		arrow1 = pg.ArrowItem(pos=(260, 55), angle=90, brush='r')
