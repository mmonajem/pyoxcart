...
with open('.\\CompositionParamètre\\OX1b_V6.ato', 'rb') as f:
    data = f.read()
...
if __name__ == "__main__":
    # save data as csv
    data_f.to_hdf('.\\CompositionParamètre\\simulation.h5', 'df', mode='w')
    # save data in csv format
    data_f.to_csv('.\\CompositionParamètre\\simulation.csv', encoding='utf-8', index=False)